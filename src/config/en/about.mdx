...
<article>
  ...
  <section class="border-b-2 border-gray-200 border-solid pb-2">
    ...
    <p>
     I am currently a Frontend Engineer, striving to transition into a Full-Stack Developer and an Indie Hacker.
    </p>
  </section>
  <section>
